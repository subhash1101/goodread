      ...
      <div className="auth-actions">
        {auth.isAuthenticated ? (
          <div className="header-icon-container">
            <Link className="header-nav-icon" title="Notifications" to="/community">
            ...
            <Link className="header-nav-icon" title="Discussions" to="/community?tab=discussions">
              <svg width="20" height="20" viewBox="0 0 24 24">
                <path d="M20 2H4c-1.1 0-1.99.9-1.99 2L2 22l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM6 9h12v2H6V9zm8 5H6v-2h8v2zm4-6H6V6h12v2z" />
              </svg>
            </Link>

            <Link className="header-nav-icon" title="Messages" to="/my-reviews">
              <svg width="19" height="19" viewBox="0 0 24 24">
                <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" />
              </svg>
            </Link>

            <Link className="header-nav-icon" title="Friends" to="/community">
              <svg width="20" height="20" viewBox="0 0 24 24">
            ...
            <div className="profile-menu-wrap">
              ...
              {profileOpen && (
                <div className="profile-dropdown" role="menu">
                  ...
                  <Link to="/community" onClick={() => setProfileOpen(false)}>Friends</Link>
                  <Link to="/community?tab=groups" onClick={() => setProfileOpen(false)}>Groups</Link>
                  <Link to="/community?tab=discussions" onClick={() => setProfileOpen(false)}>Discussions</Link>
